...
import { HOW_TO_USE_GUIDE1, HOW_TO_USE_GUIDE2, HOW_TO_USE_GUIDE3 } from '@/Constant/image';
            ...
            <div className="">
                        ...
                        <React.Fragment key={step.id}>
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                <div className="w-40 h-40 rounded-full flex items-center justify-center mb-6">
                                    <Image alt="step icon" height={100} width={100} src={step.icon} className="w-full h-full text-black" />
                                </div>
                            ...
                            {index < steps.length - 1 && (
                                <div className="flex items-start justify-center py-5 md:pt-16 md:rotate-0 rotate-90">
                                    <svg className="w-15 text-gray-400" width="100" height="17" viewBox="0 0 100 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M99.4917 8.3125L85.1 0V6.8875L0 8.3125L85.1 9.7375V16.625L99.4917 8.3125Z" fill="black" />
                                    </svg>
                                </div>
                            )}
                        </React.Fragment>
                ...
                <div className="text-center max-w-3xl mx-auto">
                    <p className="text-sm md:text-base text-gray-600 font-medium">
                        For extra volume, use a blow dryer before applying the clay. It helps lock in shape and lift without stiffness.
                    </p>
                </div>
            </div>
        </section>
