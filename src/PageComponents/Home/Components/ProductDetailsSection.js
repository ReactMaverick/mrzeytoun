...
export default function ProductDetailsSection() {
    ...
    return (
        <section className="bg-[linear-gradient(to_right,black_0,black_50%,white_50%,white_100%)]">
            <div ref={backGroundRef} className='custom-container relative bg-white py-5 sm:py-10 md:py-20'>
                <div
                ...
                <div className='relative z-10 flex md:flex-row flex-col items-center justify-between'>
                    ...
                    <div className='w-full md:w-6/12 flex flex-col gap-5'>
                        ...
                        <p className='font-extralight md:text-[20px]'>We blend science and nature to create performance-driven grooming. Every jar of MR ZEYTOUN Matte Clay nourishes while it styles, giving you texture, control, and care in one.</p>
